...
function Reserva({ fechaIn, fechaOut, contenidoJson }) {
  var [diferenciaDias, setDiferenciaDias] = useState(0);
  var [CheckFechasNoDisponibles, setCheckFechasNoDisponibles] = useState(false);
  var [datosReserva, setDatosReserva] = useState([]);
  var [mostrarFechas, setMostrarFechas] = useState(false);
  ...
  return (
    <div className='bg-white flex flex-col h-auto text-center'>
      ...
      <div className='justify-center bg-black w-3/12 rounded-lg mx-auto my-auto mt-2 h-[20em]'>
        <p className='text-white text-lg'>Codigo {codigo}</p>
